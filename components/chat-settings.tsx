        ...
        <div className="flex flex-col gap-1.5 px-2 py-2">
          ...
          <div className="flex space-x-4 items-center">
            ...
            <Input
              ...
              onChange={(e) =>
                onLanguageModelChange({
                  topP: parseInt(e.target.value) || undefined,
                })
              }
            />
          </div>
          <div className="flex space-x-4 items-center">
            ...
            <Input
              ...
              onChange={(e) =>
                onLanguageModelChange({
                  topK: parseInt(e.target.value) || undefined,
                })
              }
            />
          </div>
          <div className="flex space-x-4 items-center">
            ...
            <Input
              ...
              onChange={(e) =>
                onLanguageModelChange({
                  frequencyPenalty: parseInt(e.target.value) || undefined,
                })
              }
            />
          </div>
          <div className="flex space-x-4 items-center">
            ...
            <Input
              ...
              onChange={(e) =>
                onLanguageModelChange({
                  presencePenalty: parseInt(e.target.value) || undefined,
                })
              }
            />
          </div>
